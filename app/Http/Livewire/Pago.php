...
class Pago extends Component
{
    ...
    public $cuentaBeneficiario, $bancoBeneficiario, $tipoCuenta, $telefonoBeneficiario;
    ...
    public function addCardCompra($notaCompra, $recepcionCompra, $cantidadCompra, $cuentaBeneficiario, $bancoBeneficiario, $tipoCuenta, $telefonoBeneficiario){
    ...
    public function enviarCarrito($nota, $recepcion, $cantidad, $accion, $cuentaBeneficiario = null, $bancoBeneficiario = null, $tipoCuenta = null, $telefonoBeneficiario = null){
        if (isset($accion)) {
    ...
    public function enviarCompra($nota, $recepcion, $cantidad, $cuentaBeneficiario, $bancoBeneficiario, $tipoCuenta, $telefonoBeneficiario){
        if (auth()->check()) {
    ...
    public function render()
    {
        ...
        if (isset($this->metodo) && $this->metodo != 'Pago') {
