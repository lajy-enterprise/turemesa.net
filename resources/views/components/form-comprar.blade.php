...
@push('js')
  ...
  <script type="text/javascript" defer>
    ...
    // evio ajax
    function onEnvioComprar(notaVenta, recepcionVenta, cantidadVenta, accion){
      $.ajax({
        type:'POST',
        url: "{{ route('register') }}",
        ...
        success: function(data){
          ...
          if(accion === 'carrito'){
            @this.addCardCompra(notaVenta, recepcionVenta, valor);
          }else{
            @this.enviarCompra(notaVenta, recepcionVenta, valor);
          }
        },
    ...
    $("#smartwizard").on("leaveStep", function(e, anchorObject, currentStepIdx, nextStepIdx, stepDirection) {
          ...
          let idNameCinco = '#'+formValCompra[5].name;
          ...
          console.log(currentStepIdx);
          if(currentStepIdx == 0){
            if (formValCompra[1].value && formValCompra[3].value) {
            ...
            if (formValCompra[4].value && formValCompra[5].value && formValCompra[6].value && formValCompra[7].value && formValCompra[8].value) {
              console.log('valido form dos');
              validate = true;
            }else{
              console.log('no se valido form dos');
              if (formValCompra[4].value == "") {
                $('#step-2 div div div input'+idNameCuatro).addClass('is-invalid');
              }else{
                $('#step-2 div div div input'+idNameCuatro).removeClass('is-invalid');
              }
              if (formValCompra[5].value == "") {
                $('#step-2 div div div input'+idNameCinco).addClass('is-invalid');
              }else{
                $('#step-2 div div div input'+idNameCinco).removeClass('is-invalid');
              }
              if (formValCompra[6].value == "") {
                $('#step-2 div div div input'+idNameSeis).addClass('is-invalid');
              }else{
                $('#step-2 div div div input'+idNameSeis).removeClass('is-invalid');
              }
              if (formValCompra[7].value == "") {
                $('#step-2 div div div input'+idNameSiete).addClass('is-invalid');
              }else{
                $('#step-2 div div div input'+idNameSiete).removeClass('is-invalid');
              }
            ...
            if (formValCompra[9].value && formValCompra[10].value) {
              validate = true;
            }else{
              console.log('no se valido form tres');
              if (formValCompra[9].value == "") {
                $('#step-3 div div div input'+idNameNueve).addClass('is-invalid');
              }else{
                $('#step-3 div div div input'+idNameNueve).removeClass('is-invalid');
              }

              if (formValCompra[10].value == "") {
                $('#step-3 div div div input'+idNameDies).addClass('is-invalid');
              }else{
                $('#step-3 div div div input'+idNameDies).removeClass('is-invalid');
              }
            }
          }else{
            $('#step-3 div div div input'+idNameNueve).removeClass('is-invalid');
