      ...
      <div class="text-center text-dark pt-4">
        ...
        <div class="row my-1">
          <div class="col-12 col-md-6 mb-5 mb-md-0">
            <h6> Recargamos su cuenta Payoneer en dólares y paga en Bolívares, Zelle, Binance, USDT o Airtm. </h6>
            <a data-bs-toggle="modal" href="#comprarSaldoToggle" role="button">
              <img src="{{ asset('assets/img/botones/payoner-comprar.jpg') }}" class="img-fluid grayscale" alt="">
            </a>
          </div>
          <div class="col-12 col-md-6">
              <h6> Compramos su saldo Payoneer y le pagamos en Bolívares, Paypal, Binance, USDT o Airtm.</h6>
            <a data-bs-toggle="modal" href="#venderSaldoToggle" role="button">
              <img src="{{ asset('assets/img/botones/payoner-vender.jpg') }}" class="img-fluid grayscale" alt="">
            </a>
          </div>
        </div>
        <div class="col-12 my-3 pb-2">
          <h5 class="text-center my-1 text-dark"> Seleccione una opción de acuerdo a su necesidad </h5>
          <p class="text-center text-dark">Venda / Compre saldo Payoneer seguro y confiable.</p>
          <div class="card text-dark mb-3">
            <div class="card-header">
              <h5 class="card-title text-center text-warning">TERMINOS Y CONDICIONES PARA LA RECARGA PAYONEER</h5>
            </div>
            <div class="card-body overflow-scroll pb-3" style="height: 175px;">
              <p class="card-text py-0 my-0">
                <ol class="text-start">
                  ...
                  <li>Al momento de recibir sus datos y confirmar su pago (que este efectiva en nuestra cuenta bancaria) se le recargará su cuenta Payoneer en el transcurso de 20 minutos a 3 horas, los pagos se hacer por orden de llegada.</li>
                  ...
                  <li>La tasa del dólar Payoneer puede cambiar sin previo aviso, según se compre para el momento y la variación en el mercado. Esta tasa de cambio es el resultado de un acuerdo sólo entre las partes intervinientes y no de otro factor.</li>
          ...
          <div class="tab-content" id="comprarSaldoTabContent">
            <div class="tab-pane fade show active" id="informacion-comprar" role="tabpanel" aria-labelledby="informacion-comprar-tab">
              <div class="col-12 col-lg-10 col-xl-10 mx-auto text-center">
                <h6 class="my-3 text-center"><strong>¿Cómo recargar mi saldo Payoneer en Venezuela?</strong></h6>
                <p class="text-center">
                  <strong> Para recargar saldo a su cuenta Payoneer solo debe realizar: </strong><br><br>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
                  </svg>El monto mínimo a recargar es de $50 y el máximo dependiendo de la disponibilidad.<br><br>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
        ...
        <div class="modal-body">
          ...
          <div class="tab-content" id="venderSaldoTabContent">
            <div class="tab-pane fade show active" id="informacion-vender" role="tabpanel" aria-labelledby="informacion-vender">
              <div class="col-12 col-lg-10 col-xl-10 mx-auto text-center">
                <h6 class="my-3 text-center"><strong>¿Cómo vender mi saldo Payoneer en Venezuela?</strong></h6>
                <p class="text-center">
                  <strong>Para vender el saldo de su cuenta Payoneer solo debe comprender que:</strong> <br><br>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
                  </svg>Compramos su saldo Payoneer y reciba Bolívares en su cuenta bancaria de Venezuela o en su cuenta Paypal, Binance, USDT o Airtm.<br><br>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
                  </svg>Hacemos transferencias a todos los Bancos en Venezuela.<br><br>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
                  </svg>Lo mínimo que permite Payoneer para enviar son $50, no hay monto máximo para la compra.<br><br>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill-check text-success mx-3" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"/>
                  </svg>Para recibir en su e-mail o vía whatsapp instrucciones, detalles y tasa de cambio, dar click al botón y llene el formulario que ponemos a su disposición.
                  @auth
